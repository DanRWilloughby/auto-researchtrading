"""
Seed strategy for 30-minute timeframe. Adapted from 1h champion.
...
SHORT_WINDOW = 6      # 3 hours
MED_WINDOW = 14       # 7 hours
LONG_WINDOW = 48      # 24 hours
EMA_FAST = 8
EMA_SLOW = 42
RSI_PERIOD = 10
RSI_BULL = 50
...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            vshort_bull = ret_vshort > dyn_threshold * 0.9
            vshort_bear = ret_vshort < -dyn_threshold * 0.9
            ...
            if current_pos == 0:
                ...
                if symbol in self.entry_prices:
                    ...
                    if pnl > 0.027:  # 2.7% profit target
                        target = 0.0
