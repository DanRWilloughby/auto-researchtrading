"""
High-Octane MTF-Fusion — Aggressive sizing variant targeting 1% daily return.

Same proven MTF architecture (89% OOS retention) but with:
- Much larger position sizing (20% base vs 4%)
- Accepts higher drawdown (5-10% vs 0.1%)
- Targets $20K starting capital compounding

Key research dimensions:
- BASE_POSITION_PCT sweep: 15% → 40%
- Concentration: 8 coins vs 4 coins vs 3 coins
- Stop tightness: ATR mult 5-10 (tighter stops to control DD)
- Take profit: 1.5% → 3% (faster profit taking for compounding)
"""
...
BASE_POSITION_PCT = 3.48       # Testing with lower DD from EMA 2/8
ATR_LOOKBACK = 24
ATR_STOP_MULT = 8.0            # Optimal from Phase 2 sweep (8-10 identical)
COOLDOWN_BARS = 2
TAKE_PROFIT_PCT = 0.015        # 1.5% take profit — optimal from Phase 2
MIN_HISTORY = 60
